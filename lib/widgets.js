(function() {
  ...
  AbstractSelect = (function(_super) {
    ...
    AbstractSelect.prototype.modelChanged = function() {
      ...
      return this.ensureModelCompletion();
    };
  ...
  SingleSelect = (function(_super) {
    ...
    SingleSelect.mixins(HasSingleSelection, HasPopupMenu);
  ...
  MultiSelect = (function(_super) {
    ...
    MultiSelect.mixins(HasMultiSelection, HasPopupMenu);
