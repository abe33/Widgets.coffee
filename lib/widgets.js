(function() {
  ...
  Date.prototype.week = function(dowOffset) {
    ...
    dif = this - start - this.getTimezoneOffset() * Date.MILLISECONDS_IN_MINUTE;
  ...
  Calendar = (function(_super) {
    ...
    Calendar.prototype.updateCells = function(value) {
      var day, header, line, table, x, y, _i, _len, _ref, _ref2, _results;
