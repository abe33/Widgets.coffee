(function() {
  var AbstractDateInputWidget, AbstractMode, BGRMode, Button, Calendar, CheckBox, ColorInput, ColorPicker, Container, DateInput, DateTimeInput, DateTimeLocalInput, DropDownPopup, FilePicker, GRBMode, HSVMode, HasChildren, HasDateAndTime, HasFocusProvidedByChild, HasValueInRange, KeyStroke, MenuList, MenuModel, Module, MonthInput, NumericWidget, OpenCalendar, RGBMode, Radio, RadioGroup, SHVMode, Signal, SingleSelect, Slider, Spinner, SquarePicker, Stepper, TextArea, TextInput, TimeInput, VHSMode, WeekInput, Widget, WidgetPlugin, colorObjectFromValue, colorObjectToValue, fill, formProcessor, hex2rgb, hsv2rgb, isValidChannel, isValidColor, isValidHSV, isValidHue, isValidNumber, isValidPercentage, isValidRGB, isValidValue, keys, keystroke, radioProcessor, rgb2hex, rgb2hsv, safeInt,
  ...
  SingleSelect = (function(_super) {
    ...
    function SingleSelect(targetOrModel) {
      ...
      if (targetOrModel instanceof MenuModel) {
        SingleSelect.__super__.constructor.call(this);
    ...
    SingleSelect.prototype.ensureModelActions = function(model) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        item = _ref[_i];
        if (item.menu != null) {
          _results.push(this.ensureModelActions(item.menu));
        } else {
          if (item.action == null) {
            _results.push(item.action = this.buildActionFor(item));
          } else {
            _results.push(void 0);
          }
        }
    ...
    SingleSelect.prototype.set_model = function(property, value) {
      ...
      this.set("value", (_ref3 = this.model) != null ? (_ref4 = _ref3.items[0]) != null ? _ref4.value : void 0 : void 0);
      this.ensureModelActions();
      return value;
    };
    ...
    SingleSelect.prototype.modelChanged = function(model) {
      ...
      return this.ensureModelActions();
    };
