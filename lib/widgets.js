(function() {
  ...
  TableBuilder = (function() {
    ...
    TableBuilder.prototype.build = function() {
      var table, td, tr, unit, widget, x, y, _base, _ref, _ref2;
      table = $("<table></table>");
      if (this.options.tableClass != null) table.addClass(this.options.tableClass);
      if (this.options.tableTitle != null) {
        table.append($("<tr><th colspan='" + this.options.cols + "'>                                " + this.options.tableTitle + "                            </th></tr>"));
      }
      for (y = 0, _ref = this.options.rows - 1; 0 <= _ref ? y <= _ref : y >= _ref; 0 <= _ref ? y++ : y--) {
        tr = $("<tr></tr>");
        table.append(tr);
        for (x = 0, _ref2 = this.options.cols - 1; 0 <= _ref2 ? x <= _ref2 : x >= _ref2; 0 <= _ref2 ? x++ : x--) {
          td = $("<td></td>");
          tr.append(td);
