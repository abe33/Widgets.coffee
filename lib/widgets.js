(function() {
  var AbstractDateInputWidget, AbstractMode, BGRMode, Button, Calendar, CheckBox, ColorInput, ColorPicker, Container, DAYS, DateInput, DateTimeInput, DateTimeLocalInput, FilePicker, FocusProvidedByChild, GRBMode, HSVMode, HasChild, KeyStroke, MILLISECONDS_IN_DAY, MILLISECONDS_IN_HOUR, MILLISECONDS_IN_MINUTE, MILLISECONDS_IN_SECOND, MILLISECONDS_IN_WEEK, MenuList, MenuModel, Module, MonthInput, NumericWidget, RGBMode, Radio, RadioGroup, SHVMode, SingleSelect, Slider, SquarePicker, Stepper, TextArea, TextInput, TimeInput, VHSMode, ValueInRange, WeekInput, Widget, WidgetPlugin, colorObjectFromValue, colorObjectToValue, dateFromString, dateToString, datetimeFromString, datetimeLocalFromString, datetimeLocalToString, datetimeToString, fill, findFirstWeekFirstDay, getWeekDate, hex2rgb, hsv2rgb, isValidChannel, isValidColor, isValidDate, isValidDateTime, isValidDateTimeLocal, isValidHSV, isValidHue, isValidMonth, isValidNumber, isValidPercentage, isValidRGB, isValidTime, isValidValue, isValidWeek, keys, keystroke, monthFromString, monthToString, radioProcessor, rgb2hex, rgb2hsv, safeInt, timeFromString, timeToString, validationRegexp, weekFromString, weekToString,
    ...
    function Widget(target) {
      ...
      if (this.hasDummy) {
        ...
        if (this.hasTarget) {
          ...
          classes = (_ref = this.jTarget.attr("class")) != null ? _ref.split(/\s+/g) : void 0;
          this.addClasses.apply(this, classes);
