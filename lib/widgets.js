(function() {
  ...
  Widget = (function(_super) {
    ...
    Widget.prototype.reset = function() {
      console.log("widget reset called");
  ...
  formProcessor = function(o) {
    var form, resetButton, submitButton, widget, widgets, _i, _len,
      _this = this;
    ...
    for (_i = 0, _len = widgets.length; _i < _len; _i++) {
      widget = widgets[_i];
      if (widget.jTarget.attr("type") === "reset" && !widget.cantInteract()) {
        resetButton = widget;
      }
      if (widget.jTarget.attr("type") === "submit" && !widget.cantInteract()) {
        submitButton = widget;
      }
    }
    if (resetButton) {
      resetButton.dummy.click(function() {
        var widget, _j, _len2, _results;
        _results = [];
