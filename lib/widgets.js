(function() {
      ...
      for (y = 0, _ref2 = this.linesNeeded(value); 0 <= _ref2 ? y <= _ref2 : y >= _ref2; 0 <= _ref2 ? y++ : y--) {
        ...
        for (x = 0; x <= 6; x++) {
          ...
          cell.bind("mouseup", this.cellDelegate = function(e) {
            if (!_this.cantInteract()) {
              _this.set("value", Date.dateFromString($(e.target).attr("name")));
              return console.log("cell clicked " + ($(e.target).attr("name")));
            }
          });
          line.append(cell);
        }
  ...
  DateInput = (function(_super) {
    ...
    function DateInput(target) {
      ...
      this.dialogRequested.add(DateInput.calendar.dialogRequested, DateInput.calendar);
    ...
    DateInput.prototype.mouseup = function(e) {
      this.dialogRequested.dispatch(this);
      return e.stopImmediatePropagation();
    };
