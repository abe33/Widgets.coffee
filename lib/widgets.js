(function() {
  var AbstractDateInputWidget, AbstractMode, BGRMode, BUILDS, BuildUnit, Button, Calendar, CheckBox, ColorInput, ColorPicker, Container, DateInput, DateTimeInput, DateTimeLocalInput, DropDownPopup, FilePicker, GRBMode, HSVMode, HasChildren, HasDateAndTime, HasFocusProvidedByChild, HasValueInRange, KeyStroke, MenuList, MenuModel, Module, MonthInput, NumericWidget, OpenCalendar, RGBMode, Radio, RadioGroup, SHVMode, Signal, SingleSelect, Slider, Spinner, SquarePicker, Stepper, TableBuilder, TextArea, TextInput, TimeInput, VHSMode, WeekInput, Widget, WidgetPlugin, colorObjectFromValue, colorObjectToValue, fill, formProcessor, hex2rgb, hsv2rgb, i, isValidChannel, isValidColor, isValidHSV, isValidHue, isValidNumber, isValidPercentage, isValidRGB, isValidValue, j, keys, keystroke, radioProcessor, rgb2hex, rgb2hsv, safeInt,
