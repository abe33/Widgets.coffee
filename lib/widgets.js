(function() {
  ...
  Calendar = (function(_super) {
    ...
    Calendar.prototype.dialogRequested = function(target) {
      this.caller = target;
      return this.dummy.show();
    };
  ...
  ColorPicker = (function(_super) {
    ...
    ColorPicker.prototype.dialogRequested = function(colorinput) {
      var value,
        _this = this;
      this.caller = colorinput;
      this.originalValue = value = this.caller.get("value");
      this.set("value", value);
      ($(document)).bind("mouseup", this.documentDelegate = function(e) {
        return _this.mouseup(e);
      });
      this.dummy.css("left", this.caller.dummy.offset().left).css("top", this.caller.dummy.offset().top + this.caller.dummy.height()).css("position", "absolute").show().children(".oldColor").attr("style", "background: " + value + ";");
      return this.grabFocus();
    };
