(function() {
  var AbstractMode, BGRMode, Button, CheckBox, ColorInput, ColorPicker, Container, FilePicker, GRBMode, HSVMode, KeyStroke, MILLISECONDS_IN_DAY, MILLISECONDS_IN_HOUR, MILLISECONDS_IN_MINUTE, MILLISECONDS_IN_SECOND, MILLISECONDS_IN_WEEK, MenuList, MenuModel, NumericWidget, RGBMode, Radio, RadioGroup, SHVMode, SingleSelect, Slider, SquarePicker, Stepper, TextArea, TextInput, VHSMode, Widget, WidgetPlugin, colorObjectFromValue, colorObjectToValue, dateFromString, dateToString, datetimeFromString, datetimeToString, fill, findFirstWeekFirstDay, getWeekDate, hex2rgb, hsv2rgb, isSafeChannel, isSafeColor, isSafeHSV, isSafeHue, isSafeNumber, isSafePercentage, isSafeRGB, isSafeValue, isValidDate, isValidDateTime, isValidMonth, isValidTime, isValidWeek, keys, keystroke, monthFromString, monthToString, rgb2hex, rgb2hsv, safeInt, timeFromString, timeToString, weekFromString, weekToString,
