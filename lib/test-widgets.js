(function() {
  var AbstractMode, BGRMode, Button, CheckBox, ColorInput, ColorPicker, Container, FilePicker, GRBMode, HSVMode, KeyStroke, MILLISECONDS_IN_DAY, MILLISECONDS_IN_HOUR, MILLISECONDS_IN_MINUTE, MILLISECONDS_IN_SECOND, MILLISECONDS_IN_WEEK, MenuList, MenuModel, MockWidget, NumericWidget, RGBMode, Radio, RadioGroup, SHVMode, SingleSelect, Slider, SquarePicker, Stepper, TextArea, TextInput, VHSMode, Widget, WidgetPlugin, area1, area2, area3, button1, button2, button3, checkbox1, checkbox2, checkbox3, colorObjectFromValue, colorObjectToValue, dateFromString, dateToString, datetimeFromString, datetimeToString, dialog, fill, findFirstWeekFirstDay, getWeekDate, group, hex2rgb, hsv2rgb, input1, input2, input3, isSafeChannel, isSafeColor, isSafeHSV, isSafeHue, isSafeNumber, isSafePercentage, isSafeRGB, isSafeValue, isValidDate, isValidDateTime, isValidMonth, isValidTime, isValidWeek, item1, item2, item3, item4, item5, item6, item7, item8, keys, keystroke, list1, list2, list3, model, monthFromString, monthToString, picker1, picker2, picker3, radio1, radio2, radio3, rgb2hex, rgb2hsv, s, safeInt, select1, select2, select3, sinput1, sinput2, sinput3, sinput4, slider1, slider2, slider3, stepper1, stepper2, stepper3, target, timeFromString, timeToString, weekFromString, weekToString,
  ...
  findFirstWeekFirstDay = function(year) {
    ...
    if (day === 0) day = 7;
    if (day > 3) {
      return new Date(year, 0, 7 - day + 2);
    } else {
      return new Date(year, 0, 2 - day);
    }
  };
  ...
  getWeekDate = function(year, week) {
    ...
    return new Date(start.valueOf() + MILLISECONDS_IN_WEEK * (week - 1));
  };
