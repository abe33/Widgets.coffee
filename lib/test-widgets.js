(function() {
    ...
    Module.mixins = function() {
      ...
      for (_i = 0, _len = mixins.length; _i < _len; _i++) {
        ...
        if (mixin.constructorHook != null) {
          this.prototype.constructorHooks = this.prototype.constructorHooks.concat(mixin.constructorHook);
        }
      }
      return this;
    };
  ...
  FocusProvidedByChild = {
    ...
    unregisterFromDummyEvents: function() {
      ...
      return unregisterFromDummyEvents.__super__.constructor.call(this);
    },
    mouseup: function(e) {
