(function() {
  ...
  AbstractDateInputWidget = (function(_super) {
    ...
    AbstractDateInputWidget.prototype.createDummy = function() {
      return $("<span class='dateinput " + this.supportedType + "'>" + this.supportedType + "</span>");
    };
