(function() {
  var MockWidget, a, area1, area2, area3, button1, button2, button3, checkbox1, checkbox2, checkbox3, dialog, group, input1, input2, input3, item1, item2, item3, item4, item5, item6, item7, item8, list1, list2, list3, model, opt, picker1, picker2, picker3, radio1, radio2, radio3, s, select1, select2, select3, sinput1, sinput2, sinput3, sinput4, slider1, slider2, slider3, stepper1, stepper2, stepper3, target, testFocusProvidedByChildMixin, testGenericDateTimeFunctions, testGenericDateWidgetBehaviors, testRangeStepperMixinBehavior, testRangeStepperMixinIntervalsRunning, testRangeStepperMixinKeyboardBehavior, testRangeStepperMixinMouseWheelBehavior,
  ...
  testFocusProvidedByChildMixin = function(opt) {
  ...
  if (typeof window !== "undefined" && window !== null) {
    ...
    window.testFocusProvidedByChildMixin = testFocusProvidedByChildMixin;
  }
