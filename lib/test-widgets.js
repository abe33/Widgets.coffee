(function() {
  ...
  AbstractDateInputWidget = (function(_super) {
    ...
    AbstractDateInputWidget.mixins(RangeStepper);
    ...
    function AbstractDateInputWidget(target) {
      ...
      minDate = min != null ? this.snapToStep(this.valueToDate(min)) : void 0;
      maxDate = max != null ? this.snapToStep(this.valueToDate(max)) : void 0;
      this.properties.step = step;
      this.properties.min = minDate != null ? this.dateToValue(minDate) : null;
      this.properties.max = maxDate != null ? this.dateToValue(maxDate) : null;
    ...
    AbstractDateInputWidget.prototype.snapToStep = function(value) {
      ...
      step = this.get("step");
      if (step != null) {
        return new Date(ms - (ms % (step * MILLISECONDS_IN_SECOND)));
      } else {
        return value;
      }
    };
    ...
    AbstractDateInputWidget.prototype.increment = function() {
      ...
      step = this.get("step");
      if (step == null) step = 1;
      return this.set("date", new Date(ms + step * MILLISECONDS_IN_SECOND));
    };
  ...
  TimeInput = (function(_super) {
    ...
    function TimeInput(target) {
      ...
      if (this.get("step") == null) this.set("step", 60);
    }
