$( document ).ready ->
  ...
  test "The keystroke function should return
      an object with the specified keyCode", ->
  ...
  test "The keystroke function should return
      an object with the passed-in keycode and modifier", ->
  ...
  test "Two calls to keystroke with the same arguments
  ...
  test "The keystroke object should be able to match
      an event object", ->
