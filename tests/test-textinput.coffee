...
test "A TextInput should create a target when not provided in the constructor", ->
...
test "TextInput should know when its content had changed and the change events isn't triggered already", ->
